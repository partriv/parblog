# Django settings for socialhula project.
...
ROOT_URLCONF = 'parblog.urls'

TEMPLATE_DIRS = (
    # Put strings here, like "/home/html/django_templates" or "C:/www/django/templates".
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    settings_local.TEMPLATE_DIR,
)
...
APPEND_SLASH = True
LOGIN_URL = '/login/'
SESSION_COOKIE_NAME = settings_local.SESSION_COOKIE_NAME

TYPEKIT_CODE = getattr(settings_local, 'TYPEKIT_CODE', '')
